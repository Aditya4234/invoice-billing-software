...
import { getPayments, getApiData } from "@/lib/api";
...
const mockPayments: Payment[] = [
  { id: "PAY-001", invoiceId: "INV-001", clientName: "Acme Corp", amount: 12500, method: "Visa •• 4242", status: "completed", date: "2026-05-15", fee: 350, netAmount: 12150, reference: "ch_abc123" },
  { id: "PAY-002", invoiceId: "INV-004", clientName: "DesignStudio Co", amount: 5600, method: "Mastercard •• 5555", status: "completed", date: "2026-05-14", fee: 168, netAmount: 5432, reference: "ch_def456" },
  { id: "PAY-003", invoiceId: "INV-007", clientName: "Quantum Labs", amount: 15750, method: "Amex •• 1001", status: "completed", date: "2026-05-12", fee: 472, netAmount: 15278, reference: "ch_ghi789" },
  { id: "PAY-004", invoiceId: "INV-002", clientName: "TechStart Inc", amount: 8400, method: "PayPal", status: "pending", date: "2026-05-10", fee: 252, netAmount: 8148, reference: "pp_abc123" },
  { id: "PAY-005", invoiceId: "INV-005", clientName: "CloudBase Systems", amount: 18900, method: "Visa •• 9876", status: "completed", date: "2026-05-18", fee: 567, netAmount: 18333, reference: "ch_jkl012" },
  { id: "PAY-006", invoiceId: "INV-003", clientName: "GlobalTrade Ltd", amount: 22300, method: "Bank Transfer", status: "failed", date: "2026-05-10", fee: 669, netAmount: 21631, reference: "bt_abc456" },
  { id: "PAY-007", invoiceId: "INV-011", clientName: "Vertex Dynamics", amount: 32000, method: "Visa •• 1111", status: "completed", date: "2026-05-05", fee: 960, netAmount: 31040, reference: "ch_mno345" },
  { id: "PAY-008", invoiceId: "INV-002", clientName: "TechStart Inc", amount: 840, method: "PayPal", status: "refunded", date: "2026-05-11", fee: 25, netAmount: 815, reference: "pp_ref_001" },
  { id: "PAY-009", invoiceId: "INV-008", clientName: "Apex Digital", amount: 9800, method: "Bank Transfer", status: "pending", date: "2026-05-20", fee: 294, netAmount: 9506, reference: "bt_def789" },
  { id: "PAY-010", invoiceId: "INV-009", clientName: "Stellar Media", amount: 14500, method: "Mastercard •• 3333", status: "completed", date: "2026-05-19", fee: 435, netAmount: 14065, reference: "ch_pqr678" },
  { id: "PAY-011", invoiceId: "INV-001", clientName: "Acme Corp", amount: 12500, method: "Stripe", status: "completed", date: "2026-05-01", fee: 375, netAmount: 12125, reference: "ch_stripe_001" },
  { id: "PAY-012", invoiceId: "INV-006", clientName: "NexGen Solutions", amount: 3200, method: "PayPal", status: "failed", date: "2026-05-08", fee: 96, netAmount: 3104, reference: "pp_fail_002" },
];
...
export default function PaymentsPage() {
  ...
  useEffect(() => {
    getApiData(
      () => getPayments().then((res) => res.data.map(backendToPayment)),
      mockPayments,
    ).then(setPayments);
  }, []);
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="p-4 lg:p-8 min-w-0">
      <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.05 }} className="mb-6 lg:mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button onClick={() => showToast("Exporting payment report...")} className="flex items-center gap-2 rounded-xl bg-blue-600 px-5 py-2.5 text-sm font-medium text-white shadow-sm transition hover:bg-blue-700">
