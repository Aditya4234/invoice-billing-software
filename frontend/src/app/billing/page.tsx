...
import { getBillingPlans, getApiData } from "@/lib/api";
...
const mockBillingData: BillingRecord[] = [
  { id: "BL-001", clientName: "Acme Corp", plan: "Enterprise", amount: 2999, billingCycle: "monthly", status: "active", lastPayment: "2026-05-01", nextBilling: "2026-06-01", paymentMethod: "Visa •• 4242" },
  { id: "BL-002", clientName: "TechStart Inc", plan: "Business", amount: 1499, billingCycle: "monthly", status: "active", lastPayment: "2026-05-03", nextBilling: "2026-06-03", paymentMethod: "Mastercard •• 5555" },
  { id: "BL-003", clientName: "GlobalTrade Ltd", plan: "Enterprise", amount: 2999, billingCycle: "yearly", status: "past_due", lastPayment: "2026-04-10", nextBilling: "2026-05-10", paymentMethod: "Amex •• 1001" },
  { id: "BL-004", clientName: "DesignStudio Co", plan: "Starter", amount: 499, billingCycle: "monthly", status: "trialing", lastPayment: "—", nextBilling: "2026-06-15", paymentMethod: "N/A" },
  { id: "BL-005", clientName: "CloudBase Systems", plan: "Business", amount: 1499, billingCycle: "monthly", status: "active", lastPayment: "2026-05-06", nextBilling: "2026-06-06", paymentMethod: "Visa •• 9876" },
  { id: "BL-006", clientName: "NexGen Solutions", plan: "Starter", amount: 499, billingCycle: "monthly", status: "cancelled", lastPayment: "2026-04-01", nextBilling: "—", paymentMethod: "PayPal" },
  { id: "BL-007", clientName: "Quantum Labs", plan: "Enterprise", amount: 2999, billingCycle: "quarterly", status: "active", lastPayment: "2026-04-20", nextBilling: "2026-07-20", paymentMethod: "Visa •• 4242" },
  { id: "BL-008", clientName: "Apex Digital", plan: "Starter", amount: 499, billingCycle: "monthly", status: "active", lastPayment: "2026-05-01", nextBilling: "2026-06-01", paymentMethod: "Bank Transfer" },
  { id: "BL-009", clientName: "Stellar Media", plan: "Business", amount: 1499, billingCycle: "monthly", status: "active", lastPayment: "2026-05-09", nextBilling: "2026-06-09", paymentMethod: "Mastercard •• 3333" },
  { id: "BL-010", clientName: "Pinnacle Group", plan: "Business", amount: 1499, billingCycle: "yearly", status: "cancelled", lastPayment: "2025-10-15", nextBilling: "—", paymentMethod: "Amex •• 2002" },
  { id: "BL-011", clientName: "Vertex Dynamics", plan: "Enterprise", amount: 2999, billingCycle: "monthly", status: "active", lastPayment: "2026-05-05", nextBilling: "2026-06-05", paymentMethod: "Visa •• 1111" },
  { id: "BL-012", clientName: "NorthStar Analytics", plan: "Starter", amount: 499, billingCycle: "monthly", status: "trialing", lastPayment: "—", nextBilling: "2026-06-20", paymentMethod: "N/A" },
];
...
export default function BillingPage() {
  ...
  useEffect(() => {
    getApiData(
      () => getBillingPlans().then((res) => res.data.map(backendToBilling)),
      mockBillingData,
    ).then(setBillingData);
  }, []);
