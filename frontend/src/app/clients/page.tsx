...
import { getAllClients, createClient, getApiData } from "@/lib/api";
...
const mockClients: Client[] = [
  { id: "CL-001", name: "Acme Corp", email: "billing@acme.com", phone: "+1 (555) 123-4567", company: "Acme Corporation", city: "San Francisco", state: "CA", gstin: "GSTIN-27AABCU1234D1Z5", totalInvoices: 24, totalAmount: 284500, status: "active", createdAt: "2025-01-15" },
  { id: "CL-002", name: "TechStart Inc", email: "finance@techstart.io", phone: "+1 (555) 234-5678", company: "TechStart Innovations", city: "New York", state: "NY", gstin: "GSTIN-36AABCU5678H1Z9", totalInvoices: 18, totalAmount: 192300, status: "active", createdAt: "2025-02-20" },
  { id: "CL-003", name: "GlobalTrade Ltd", email: "ap@globaltrade.com", phone: "+1 (555) 345-6789", company: "GlobalTrade Solutions", city: "London", state: "UK", gstin: "GSTIN-07AEFCS9012K1Z3", totalInvoices: 31, totalAmount: 445000, status: "active", createdAt: "2024-11-10" },
  { id: "CL-004", name: "DesignStudio Co", email: "payments@designstudio.co", phone: "+1 (555) 456-7890", company: "DesignStudio Creative", city: "Los Angeles", state: "CA", gstin: "GSTIN-33AAHCQ3456L1Z7", totalInvoices: 12, totalAmount: 98700, status: "active", createdAt: "2025-04-05" },
  { id: "CL-005", name: "CloudBase Systems", email: "billing@cloudbase.io", phone: "+1 (555) 567-8901", company: "CloudBase Technologies", city: "Seattle", state: "WA", gstin: "GSTIN-24AAVBE7890M1Z1", totalInvoices: 9, totalAmount: 156000, status: "active", createdAt: "2025-03-12" },
  { id: "CL-006", name: "NexGen Solutions", email: "accounting@nexgen.com", phone: "+1 (555) 678-9012", company: "NexGen Business Solutions", city: "Austin", state: "TX", gstin: "GSTIN-08AANCS1234N1Z4", totalInvoices: 15, totalAmount: 221400, status: "inactive", createdAt: "2024-09-01" },
  { id: "CL-007", name: "Quantum Labs", email: "finance@quantumlab.org", phone: "+1 (555) 789-0123", company: "Quantum Research Labs", city: "Boston", state: "MA", gstin: "GSTIN-06AAUAD5678O1Z8", totalInvoices: 22, totalAmount: 378900, status: "active", createdAt: "2024-07-20" },
  { id: "CL-008", name: "Apex Digital", email: "invoices@apex.digital", phone: "+1 (555) 890-1234", company: "Apex Digital Media", city: "Chicago", state: "IL", gstin: "GSTIN-19AAECP9012P1Z2", totalInvoices: 7, totalAmount: 82300, status: "active", createdAt: "2025-05-01" },
  { id: "CL-009", name: "Stellar Media", email: "accounts@stellarmedia.com", phone: "+1 (555) 901-2345", company: "Stellar Media Group", city: "Miami", state: "FL", gstin: "GSTIN-27AABCS6789Q1Z6", totalInvoices: 14, totalAmount: 178500, status: "active", createdAt: "2025-01-28" },
  { id: "CL-010", name: "Pinnacle Group", email: "finance@pinnacle.com", phone: "+1 (555) 012-3456", company: "Pinnacle Consulting", city: "Denver", state: "CO", gstin: "GSTIN-29AAECG9012R1Z4", totalInvoices: 11, totalAmount: 134200, status: "inactive", createdAt: "2024-10-15" },
  { id: "CL-011", name: "Vertex Dynamics", email: "ap@vertexdyn.com", phone: "+1 (555) 123-8901", company: "Vertex Dynamics Inc", city: "Portland", state: "OR", gstin: "GSTIN-07AAECD3456S1Z2", totalInvoices: 28, totalAmount: 512000, status: "active", createdAt: "2024-06-01" },
  { id: "CL-012", name: "NorthStar Analytics", email: "billing@northstar.io", phone: "+1 (555) 234-9012", company: "NorthStar Data Analytics", city: "Atlanta", state: "GA", gstin: "GSTIN-33AAHCN7890T1Z8", totalInvoices: 6, totalAmount: 94500, status: "active", createdAt: "2025-04-20" },
];
...
export default function ClientsPage() {
  ...
  useEffect(() => {
    getApiData(
      () => getAllClients().then((res) => res.map(backendToClient)),
      mockClients,
    ).then(setClients);
  }, []);
        ...
        {selectedClient && (
          <div className="space-y-6">
            ...
            <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
              <button onClick={() => showToast("Edit feature coming soon")} className="flex items-center gap-2 rounded-xl border border-gray-200 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 transition"><Edit size={16} /> Edit</button>
              <button onClick={() => showToast(`Email sent to ${selectedClient.email}`)} className="flex items-center gap-2 rounded-xl bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 transition"><Mail size={16} /> Send Email</button>
            </div>
          </div>
        )}
      </Modal>
