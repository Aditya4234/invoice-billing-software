...
import { getEmployees, getDepartments, deleteEmployee, getApiData } from "@/lib/api";
...
export default function EmployeesPage() {
  ...
  useEffect(() => {
    getApiData(
      () => getEmployees().then((res) => res.data.map(backendToEmployee)),
      []
    ).then(setEmployees);
        ...
        {selectedEmp && (
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3 border-t border-gray-100 pt-4">
              <Link href={`/employees/${selectedEmp.id}`} className="flex items-center gap-2 rounded-xl bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 transition">
