...
import { getAttendance, getAllEmployees, getApiData, markAttendance, updateAttendance } from "@/lib/api";
...
export default function AttendancePage() {
  ...
  useEffect(() => {
    ...
    getApiData(() => getAttendance().then(res => res.data), []).then(setAttendanceRecords);
  ...
  const saveAllChanges = async () => {
    ...
    setChanges({});
    const fresh = await getApiData(() => getAttendance().then(res => res.data), []);
