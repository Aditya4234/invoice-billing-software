...
import { getAllInvoices, updateInvoice, deleteInvoice, getApiData } from "@/lib/api";
...
export default function InvoicesPage() {
  ...
  useEffect(() => {
    getApiData(getAllInvoices, mockInvoices).then(setInvoices);
  }, []);
                  ...
                  <td className="px-4 py-4 last:pr-6">
                    <div className="flex items-center justify-end gap-1">
                      ...
                      <Dropdown
                        ...
                        items={[
                          { label: "View Details", icon: Eye, onClick: () => window.location.href = `/invoices/${invoice.id}` },
                          ...
                          { label: "Send Reminder", icon: undefined, onClick: () => showToastFn(`Reminder sent for ${invoice.id}`) },
