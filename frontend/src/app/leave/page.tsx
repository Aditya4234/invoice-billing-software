...
import { getLeaveRequests, getAllEmployees, getApiData, createLeaveRequest, updateLeaveRequest } from "@/lib/api";
...
export default function LeavePage() {
  ...
  const loadLeaveRequests = () => {
    getApiData(() => getLeaveRequests().then(res => res.data), []).then((res) => {
      setLeaveRequests(res.map((l: any) => {
