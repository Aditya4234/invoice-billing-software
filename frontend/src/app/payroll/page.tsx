...
import { getPayrollRecords, getAllEmployees, getApiData } from "@/lib/api";
...
export default function PayrollPage() {
  ...
  useEffect(() => {
    ...
    getApiData(() => getPayrollRecords().then(res => res.data), []).then((res) => {
      setPayrollRecords(res.map((p: any) => {
      ...
      <Modal open={showRunPayroll} onClose={() => setShowRunPayroll(false)} title="Run Payroll" size="md">
        <div className="space-y-4">
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
            ...
            <button onClick={() => { setShowRunPayroll(false); showToast("Payroll processing initiated"); }} className="rounded-xl bg-emerald-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-emerald-700 transition">
